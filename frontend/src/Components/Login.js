...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    const response = await fetch('https://www.generatepassword.ashadashraf.com/api/login/', {
            method: 'POST',
            headers: {
  ...
  const handleSignup = async (e) => {
    ...
    const response = await fetch('https://www.generatepassword.ashadashraf.com/api/register/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
